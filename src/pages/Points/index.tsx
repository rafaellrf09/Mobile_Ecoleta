...
const Points = () => {
  ...
  useEffect( () => {
    async function loadPosition() {
      ...
      if( status !== 'granted'){ 
        Alert.alert("Ooooops...", "Precisamos de sua permissão para obter a localização atual.");
        return;
      }
                ...
                <View style={styles.mapContainer}>
                    {
                      initialPosition[0] !== 0 && (
                        <MapView 
                        style={styles.map} 
                        initialRegion={{ latitude: initialPosition[0], longitude: initialPosition[1], latitudeDelta:0.010, longitudeDelta: 0.010}}
